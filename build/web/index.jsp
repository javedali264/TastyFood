<%-- 
    Document   : index
    Created on : Nov 6, 2017, 8:50:26 PM
    Author     : Sameer Alam
--%>
		...
		<div class="container">
			...
			<div class="header">
				...
				<div class="top-nav">
					...
					<ul>
						<li class="wow slideInDown animated" data-wow-delay=".5s"><a class="active" href="index.jsp">Home</a></li>
						<li class="wow slideInDown" data-wow-delay=".6s"><a href="about.jsp">About</a></li>					
						<li class="wow slideInDown" data-wow-delay=".7s"><a href="gallery.jsp">Gallery</a></li>
						<li class="wow slideInDown" data-wow-delay=".7s"><a href="codes.jsp">Codes</a></li>
						<li class="wow slideInDown" data-wow-delay=".8s"><a href="blog.jsp">Blog</a></li>
						<li class="wow slideInDown" data-wow-delay=".9s"><a href="contact.jsp">Contact</a></li>
					</ul>
					<!-- script-for-menu -->
					<script>					
			...
			<div class="bnr-text wow slideInUp animated" data-wow-delay=".5s">
				...
				<a href="about.jsp" class="more more-right">More About</a>
				<a href="single.jsp" class="more more-left">Learn More</a>
			</div>
		</div>	
	</div>	
	<!--//banner--> 
