<%-- 
    Document   : admin
    Created on : Nov 28, 2017, 8:36:41 PM
    Author     : Sameer Alam
--%>
...
<body>
	...
	<div class="banner about-banner">
		<div class="container">
			...
			<div class="bnr-text wow slideInLeft animated" data-wow-delay=".7s">
				<h2 class="bnr-title agileinfo">Login</h2>
			</div>	
		</div>	
	</div>	
	<!--//banner--> 
    ...
    <br><BR>
            ...
            <input type="email" name="signup" class="form-control"  placeholder="email" required="javedali123@gmail.com">
              <br>
              
              <input type="password" name="pass" class="form-control" placeholder="password" required="786786">
             <br>
