...
<a class="navbar-brand" href="#" style="color:#17A589">Food Club</a>
      ...
      <ul class="nav navbar-nav navbar-right">
          ...
          <!-- User Name -->
          <li><a href="#"><span class="glyphicon glyphicon-user"></span> <b style="color:green">Welcome </b><b style="color:Orange"> Javed as Admin</b></a></li>
...
<!-- User Registration Button -->
	<li ><a href="login.jsp"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
        ...
        <form action="foodsupload" method="post" style="margin: auto; width: 80%; text-align: center;" enctype="multipart/form-data">
            ...
            <input type="text" name ="name" class="form-control" placeholder="Your Food Name" style="height:40px" required>
              <br>
              <input type="text" name ="price" class="form-control" placeholder="Your Food Price" style="height:40px" required>
              <br>
              <center>
