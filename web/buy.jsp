<%-- 
    Document   : buy
    Created on : Nov 12, 2017, 5:15:39 PM
    Author     : Sameer Alam
--%>
			...
			<div class="header">
				...
				<div class="top-nav">
					...
					<ul>
						...
						<li class="wow slideInDown animated" data-wow-delay=".6s"><a href="about.html">About</a></li>					
						<li class="wow slideInDown animated" data-wow-delay=".7s"><a href="gallery.html">Gallery</a></li>
						<li class="wow slideInDown animated" data-wow-delay=".8s"><a href="blog.html">Blog</a></li>
                                                <li class="wow slideInDown animated" data-wow-delay=".9s"><a href="contact.html">Contact</a></li><br><BR>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <a href="biryani.jsp"><div class="panel-body"><img src="images/new.jpg" class="img-responsive" style="width:100%" alt="Image"></div></a>
        <div class="panel-footer"><b style="color:red;">Buy at  </b><img src="images/ic.png"/><b>299 - 599 </b></div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        <div class="panel-heading">Rice</div>
        <a href="swift_inner.jsp"><div class="panel-body"><img src="images/rice.jpg" class="img-responsive" style="width:100%" alt="Image"></div></a>
        <div class="panel-footer"><b style="color:red;">Buy at  </b><img src="images/ic.png"/><b>99 - 399 </b></div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        <div class="panel-heading">Naan</div>
        <a href="honda_inner.jsp"><div class="panel-body"><img src="images/naan.jpg" class="img-responsive" style="width:100%" alt="Image"></div></a>
        <div class="panel-footer"><b style="color:red;">Buy at  </b><img src="images/ic.png"/><b>99 - 249 </b></div>
      </div>
    </div>
  </div>
</div><br>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <a href="baleno_inner.jsp"><div class="panel-body"><img src="images/korma.jpg" class="img-responsive" style="width:100%" alt="Image"></div></a>
	...
	<div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <a href="scorepio_inner.jsp"><div class="panel-body"><img src="images/mixdosa.jpg" class="img-responsive" style="width:100%" alt="Image"></div></a>
        <div class="panel-footer" ><b style="color:red;">Buy at  </b><img src="images/ic.png"/><b>99 - 399 </b></div>
      </div>
    </div>
	<div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <a href="pajero_inner.jsp"><div class="panel-body"><img src="images/Chinese_Cook.jpeg" class="img-responsive" style="width:100%" alt="Image"></div></a>
        <div class="panel-footer"><b style="color:red;">Buy at  </b><img src="images/ic.png"/><b>99 - 250 </b></div>
      </div>
    </div>
<div class="col-sm-4"> 
      <div class="panel panel-primary">
        <div class="panel-heading">kabab</div>
        <a href="alto_inner.jsp"><div class="panel-body"><img src="images/mixed-kabab.jpg" class="img-responsive" style="width:100%" alt="Image"></div></a>
        <div class="panel-footer"><b style="color:red;">Buy at  </b><img src="images/ic.png"/><b>299 - 599 </b></div>
      </div>
    </div><div class="col-sm-4"> 
      <div class="panel panel-primary">
        <div class="panel-heading">Sweets</div>
        <a href="innova_inner.jsp"><div class="panel-body"><img src="images/sweets.jpg" class="img-responsive" style="width:100%" alt="Image"></div></a>
